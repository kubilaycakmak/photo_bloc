...
void main() {
  ...
  final HitsRepository repository = HitsRepository(
    hitsApiClient: HitsApiClient(
...
class MyApp extends StatefulWidget {
  ...
  const MyApp({Key key, this.repository}) : assert(repository != null), super(key: key);
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: FloatingNavbar(
          ...
          items:[
            ...
            FloatingNavbarItem(
              icon: selectedIndex == 1 ? CupertinoIcons.collections_solid : CupertinoIcons.collections, 
              title: 'Category'
            ),
            FloatingNavbarItem(
